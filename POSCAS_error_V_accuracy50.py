...
if __name__ == "__main__":
    ...
    np.save("resultsPOSCAS_error_V/accuracy50/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsPOSCAS_error_V/accuracy50/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsPOSCAS_error_V/accuracy50/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsPOSCAS_error_V/accuracy50/runtime.npy", end_time - start_time)
