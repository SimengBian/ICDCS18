...
if __name__ == "__main__":
    ...
    np.save("resultsP-ONRA/wsize1/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsP-ONRA/wsize1/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsP-ONRA/wsize1/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsP-ONRA/wsize1/varOfQueueBacklogs.npy", varOfQueueBacklogs)

    np.save("resultsP-ONRA/wsize1/runtime.npy", end_time - start_time)
