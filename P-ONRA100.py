...
if __name__ == "__main__":
    ...
    np.save("resultsP-ONRA/wsize100/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsP-ONRA/wsize100/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsP-ONRA/wsize100/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsP-ONRA/wsize100/varOfQueueBacklogs.npy", varOfQueueBacklogs)

    np.save("resultsP-ONRA/wsize100/runtime.npy", end_time - start_time)
