...
serverCapacities = np.array([500 for s in range(numOfServer)])
...
if __name__ == "__main__":
    ...
    np.save("resultsPOSCAS_perfect_Cap/capacity500/avgDelays.npy", avgDelays)
    end_time = time()
    np.save("resultsPOSCAS_perfect_Cap/capacity500/runtime.npy", end_time - start_time)
