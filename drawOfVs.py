...
metric = 3  # 0: queue backlogs; 1: energy costs; 2: comm. costs; 3: energy costs + gamma * communication costs.

queues = np.load("resultsONRA/timeAverageOfQueueBacklogs.npy")
energies = np.load("resultsONRA/timeAverageOfEnergyCosts.npy")
communications = np.load("resultsONRA/timeAverageOfCommunicationCosts.npy")
