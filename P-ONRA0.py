...
windowSizes = 0 * np.ones(numOfSC, dtype=int)
...
if __name__ == "__main__":
    ...
    np.save("resultsP-ONRA/wsize0/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsP-ONRA/wsize0/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsP-ONRA/wsize0/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsP-ONRA/wsize0/varOfQueueBacklogs.npy", varOfQueueBacklogs)

    np.save("resultsP-ONRA/wsize0/runtime.npy", end_time - start_time)
