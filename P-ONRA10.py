...
if __name__ == "__main__":
    ...
    np.save("resultsP-ONRA/wsize10/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsP-ONRA/wsize10/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsP-ONRA/wsize10/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsP-ONRA/wsize10/varOfQueueBacklogs.npy", varOfQueueBacklogs)

    np.save("resultsP-ONRA/wsize10/runtime.npy", end_time - start_time)
