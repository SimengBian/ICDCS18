...
if __name__ == "__main__":
    ...
    np.save("resultsPOSCAS_error_V/accuracy90/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsPOSCAS_error_V/accuracy90/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsPOSCAS_error_V/accuracy90/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsPOSCAS_error_V/accuracy90/runtime.npy", end_time - start_time)
