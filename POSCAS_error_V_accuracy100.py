...
if __name__ == "__main__":
    ...
    np.save("resultsPOSCAS_error_V/accuracy100/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsPOSCAS_error_V/accuracy100/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsPOSCAS_error_V/accuracy100/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsPOSCAS_error_V/accuracy100/runtime.npy", end_time - start_time)
