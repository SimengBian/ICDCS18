...
if __name__ == "__main__":
    ...
    np.save("resultsP-ONRA/wsize5/timeAverageOfQueueBacklogs.npy", timeAverageOfQueueBacklogsNew)
    np.save("resultsP-ONRA/wsize5/timeAverageOfEnergyCosts.npy", timeAverageOfEnergyCostsNew)
    np.save("resultsP-ONRA/wsize5/timeAverageOfCommunicationCosts.npy", timeAverageOfCommunicationCostsNew)
    np.save("resultsP-ONRA/wsize5/varOfQueueBacklogs.npy", varOfQueueBacklogs)

    np.save("resultsP-ONRA/wsize5/runtime.npy", end_time - start_time)
